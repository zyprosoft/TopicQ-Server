...
class CommentController extends AbstractController
{
    ...
    public function create(AuthedRequest $request)
    {
        $this->validate([
            ...
            'postId' => 'integer|min:1|exists:post,post_id',
        ...
        $audioDuration = $request->param('audioDuration');
        $result = $this->service->create($postId, $content, $imageList, $link, $atUserList, $audioUrl,$audioDuration);
    ...
    public function reply(AuthedRequest $request)
    {
        ...
        $audioUrl = $request->param('audioUrl');
        $audioDuration = $request->param('audioDuration');
        $result = $this->service->reply($commentId, $content, $imageList, $link, $atUserList, $audioUrl, $audioDuration);
        return $this->success($result);
    }
